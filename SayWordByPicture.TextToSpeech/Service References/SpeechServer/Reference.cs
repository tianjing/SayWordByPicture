...
// 
namespace SayWordByPicture.TextToSpeech.SpeechServer {
    ...
    public partial class GetTranslationsResponse : object, System.ComponentModel.INotifyPropertyChanged {
        ...
        private SayWordByPicture.TextToSpeech.SpeechServer.TranslationMatch[] TranslationsField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute(EmitDefaultValue=false)]
        public SayWordByPicture.TextToSpeech.SpeechServer.TranslationMatch[] Translations {
            get {
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://api.microsofttranslator.com/V2", ConfigurationName="SpeechServer.LanguageService")]
    public interface LanguageService {
        ...
        System.IAsyncResult BeginGetTranslations(string appId, string text, string from, string to, int maxTranslations, SayWordByPicture.TextToSpeech.SpeechServer.TranslateOptions options, System.AsyncCallback callback, object asyncState);
        
        SayWordByPicture.TextToSpeech.SpeechServer.GetTranslationsResponse EndGetTranslations(System.IAsyncResult result);
        ...
        [System.ServiceModel.OperationContractAttribute(AsyncPattern=true, Action="http://api.microsofttranslator.com/V2/LanguageService/AddTranslationArray", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/AddTranslationArrayResponse" +
            "")]
        System.IAsyncResult BeginAddTranslationArray(string appId, SayWordByPicture.TextToSpeech.SpeechServer.Translation[] translations, string from, string to, SayWordByPicture.TextToSpeech.SpeechServer.TranslateOptions options, System.AsyncCallback callback, object asyncState);
        ...
        [System.ServiceModel.OperationContractAttribute(AsyncPattern=true, Action="http://api.microsofttranslator.com/V2/LanguageService/GetTranslationsArray", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/GetTranslationsArrayRespons" +
            "e")]
        System.IAsyncResult BeginGetTranslationsArray(string appId, string[] texts, string from, string to, int maxTranslations, SayWordByPicture.TextToSpeech.SpeechServer.TranslateOptions options, System.AsyncCallback callback, object asyncState);
        
        SayWordByPicture.TextToSpeech.SpeechServer.GetTranslationsResponse[] EndGetTranslationsArray(System.IAsyncResult result);
        ...
        System.IAsyncResult BeginTranslateArray(string appId, string[] texts, string from, string to, SayWordByPicture.TextToSpeech.SpeechServer.TranslateOptions options, System.AsyncCallback callback, object asyncState);
        
        SayWordByPicture.TextToSpeech.SpeechServer.TranslateArrayResponse[] EndTranslateArray(System.IAsyncResult result);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface LanguageServiceChannel : SayWordByPicture.TextToSpeech.SpeechServer.LanguageService, System.ServiceModel.IClientChannel {
    }
    ...
    public partial class GetTranslationsCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        ...
        public SayWordByPicture.TextToSpeech.SpeechServer.GetTranslationsResponse Result {
            get {
                base.RaiseExceptionIfNecessary();
                return ((SayWordByPicture.TextToSpeech.SpeechServer.GetTranslationsResponse)(this.results[0]));
            }
        }
    }
    ...
    public partial class TranslateArrayCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        ...
        public SayWordByPicture.TextToSpeech.SpeechServer.TranslateArrayResponse[] Result {
            get {
                base.RaiseExceptionIfNecessary();
                return ((SayWordByPicture.TextToSpeech.SpeechServer.TranslateArrayResponse[])(this.results[0]));
            }
        }
    }
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class LanguageServiceClient : System.ServiceModel.ClientBase<SayWordByPicture.TextToSpeech.SpeechServer.LanguageService>, SayWordByPicture.TextToSpeech.SpeechServer.LanguageService {
        ...
        System.IAsyncResult SayWordByPicture.TextToSpeech.SpeechServer.LanguageService.BeginAddTranslation(string appId, string originalText, string translatedText, string from, string to, int rating, string contentType, string category, string user, string uri, System.AsyncCallback callback, object asyncState) {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        void SayWordByPicture.TextToSpeech.SpeechServer.LanguageService.EndAddTranslation(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginAddTranslation(object[] inValues, System.AsyncCallback callback, object asyncState) {
            ...
            return ((SayWordByPicture.TextToSpeech.SpeechServer.LanguageService)(this)).BeginAddTranslation(appId, originalText, translatedText, from, to, rating, contentType, category, user, uri, callback, asyncState);
        }
        
        private object[] OnEndAddTranslation(System.IAsyncResult result) {
            ((SayWordByPicture.TextToSpeech.SpeechServer.LanguageService)(this)).EndAddTranslation(result);
            return null;
        }
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult SayWordByPicture.TextToSpeech.SpeechServer.LanguageService.BeginBreakSentences(string appId, string text, string language, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginBreakSentences(appId, text, language, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        int[] SayWordByPicture.TextToSpeech.SpeechServer.LanguageService.EndBreakSentences(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginBreakSentences(object[] inValues, System.AsyncCallback callback, object asyncState) {
            ...
            return ((SayWordByPicture.TextToSpeech.SpeechServer.LanguageService)(this)).BeginBreakSentences(appId, text, language, callback, asyncState);
        }
        
        private object[] OnEndBreakSentences(System.IAsyncResult result) {
            int[] retVal = ((SayWordByPicture.TextToSpeech.SpeechServer.LanguageService)(this)).EndBreakSentences(result);
            return new object[] {
                    retVal};
        }
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult SayWordByPicture.TextToSpeech.SpeechServer.LanguageService.BeginDetect(string appId, string text, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginDetect(appId, text, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        string SayWordByPicture.TextToSpeech.SpeechServer.LanguageService.EndDetect(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginDetect(object[] inValues, System.AsyncCallback callback, object asyncState) {
            string appId = ((string)(inValues[0]));
            string text = ((string)(inValues[1]));
            return ((SayWordByPicture.TextToSpeech.SpeechServer.LanguageService)(this)).BeginDetect(appId, text, callback, asyncState);
        }
        
        private object[] OnEndDetect(System.IAsyncResult result) {
            string retVal = ((SayWordByPicture.TextToSpeech.SpeechServer.LanguageService)(this)).EndDetect(result);
            return new object[] {
                    retVal};
        }
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult SayWordByPicture.TextToSpeech.SpeechServer.LanguageService.BeginDetectArray(string appId, string[] texts, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginDetectArray(appId, texts, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        string[] SayWordByPicture.TextToSpeech.SpeechServer.LanguageService.EndDetectArray(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginDetectArray(object[] inValues, System.AsyncCallback callback, object asyncState) {
            ...
            return ((SayWordByPicture.TextToSpeech.SpeechServer.LanguageService)(this)).BeginDetectArray(appId, texts, callback, asyncState);
        }
        
        private object[] OnEndDetectArray(System.IAsyncResult result) {
            string[] retVal = ((SayWordByPicture.TextToSpeech.SpeechServer.LanguageService)(this)).EndDetectArray(result);
            return new object[] {
                    retVal};
        }
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult SayWordByPicture.TextToSpeech.SpeechServer.LanguageService.BeginGetAppIdToken(string appId, int minRatingRead, int maxRatingWrite, int expireSeconds, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginGetAppIdToken(appId, minRatingRead, maxRatingWrite, expireSeconds, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        string SayWordByPicture.TextToSpeech.SpeechServer.LanguageService.EndGetAppIdToken(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginGetAppIdToken(object[] inValues, System.AsyncCallback callback, object asyncState) {
            ...
            return ((SayWordByPicture.TextToSpeech.SpeechServer.LanguageService)(this)).BeginGetAppIdToken(appId, minRatingRead, maxRatingWrite, expireSeconds, callback, asyncState);
        }
        
        private object[] OnEndGetAppIdToken(System.IAsyncResult result) {
            string retVal = ((SayWordByPicture.TextToSpeech.SpeechServer.LanguageService)(this)).EndGetAppIdToken(result);
            return new object[] {
                    retVal};
        }
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult SayWordByPicture.TextToSpeech.SpeechServer.LanguageService.BeginGetLanguageNames(string appId, string locale, string[] languageCodes, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginGetLanguageNames(appId, locale, languageCodes, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        string[] SayWordByPicture.TextToSpeech.SpeechServer.LanguageService.EndGetLanguageNames(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginGetLanguageNames(object[] inValues, System.AsyncCallback callback, object asyncState) {
            ...
            return ((SayWordByPicture.TextToSpeech.SpeechServer.LanguageService)(this)).BeginGetLanguageNames(appId, locale, languageCodes, callback, asyncState);
        }
        
        private object[] OnEndGetLanguageNames(System.IAsyncResult result) {
            string[] retVal = ((SayWordByPicture.TextToSpeech.SpeechServer.LanguageService)(this)).EndGetLanguageNames(result);
            return new object[] {
                    retVal};
        }
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult SayWordByPicture.TextToSpeech.SpeechServer.LanguageService.BeginGetLanguagesForSpeak(string appId, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginGetLanguagesForSpeak(appId, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        string[] SayWordByPicture.TextToSpeech.SpeechServer.LanguageService.EndGetLanguagesForSpeak(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginGetLanguagesForSpeak(object[] inValues, System.AsyncCallback callback, object asyncState) {
            string appId = ((string)(inValues[0]));
            return ((SayWordByPicture.TextToSpeech.SpeechServer.LanguageService)(this)).BeginGetLanguagesForSpeak(appId, callback, asyncState);
        }
        
        private object[] OnEndGetLanguagesForSpeak(System.IAsyncResult result) {
            string[] retVal = ((SayWordByPicture.TextToSpeech.SpeechServer.LanguageService)(this)).EndGetLanguagesForSpeak(result);
            return new object[] {
                    retVal};
        }
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult SayWordByPicture.TextToSpeech.SpeechServer.LanguageService.BeginGetLanguagesForTranslate(string appId, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginGetLanguagesForTranslate(appId, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        string[] SayWordByPicture.TextToSpeech.SpeechServer.LanguageService.EndGetLanguagesForTranslate(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginGetLanguagesForTranslate(object[] inValues, System.AsyncCallback callback, object asyncState) {
            string appId = ((string)(inValues[0]));
            return ((SayWordByPicture.TextToSpeech.SpeechServer.LanguageService)(this)).BeginGetLanguagesForTranslate(appId, callback, asyncState);
        }
        
        private object[] OnEndGetLanguagesForTranslate(System.IAsyncResult result) {
            string[] retVal = ((SayWordByPicture.TextToSpeech.SpeechServer.LanguageService)(this)).EndGetLanguagesForTranslate(result);
            return new object[] {
                    retVal};
        }
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult SayWordByPicture.TextToSpeech.SpeechServer.LanguageService.BeginGetTranslations(string appId, string text, string from, string to, int maxTranslations, SayWordByPicture.TextToSpeech.SpeechServer.TranslateOptions options, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginGetTranslations(appId, text, from, to, maxTranslations, options, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        SayWordByPicture.TextToSpeech.SpeechServer.GetTranslationsResponse SayWordByPicture.TextToSpeech.SpeechServer.LanguageService.EndGetTranslations(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginGetTranslations(object[] inValues, System.AsyncCallback callback, object asyncState) {
            ...
            SayWordByPicture.TextToSpeech.SpeechServer.TranslateOptions options = ((SayWordByPicture.TextToSpeech.SpeechServer.TranslateOptions)(inValues[5]));
            return ((SayWordByPicture.TextToSpeech.SpeechServer.LanguageService)(this)).BeginGetTranslations(appId, text, from, to, maxTranslations, options, callback, asyncState);
        }
        
        private object[] OnEndGetTranslations(System.IAsyncResult result) {
            SayWordByPicture.TextToSpeech.SpeechServer.GetTranslationsResponse retVal = ((SayWordByPicture.TextToSpeech.SpeechServer.LanguageService)(this)).EndGetTranslations(result);
            return new object[] {
                    retVal};
        }
        ...
        public void GetTranslationsAsync(string appId, string text, string from, string to, int maxTranslations, SayWordByPicture.TextToSpeech.SpeechServer.TranslateOptions options) {
            this.GetTranslationsAsync(appId, text, from, to, maxTranslations, options, null);
        }
        
        public void GetTranslationsAsync(string appId, string text, string from, string to, int maxTranslations, SayWordByPicture.TextToSpeech.SpeechServer.TranslateOptions options, object userState) {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult SayWordByPicture.TextToSpeech.SpeechServer.LanguageService.BeginTranslate(string appId, string text, string from, string to, string contentType, string category, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginTranslate(appId, text, from, to, contentType, category, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        string SayWordByPicture.TextToSpeech.SpeechServer.LanguageService.EndTranslate(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginTranslate(object[] inValues, System.AsyncCallback callback, object asyncState) {
            ...
            return ((SayWordByPicture.TextToSpeech.SpeechServer.LanguageService)(this)).BeginTranslate(appId, text, from, to, contentType, category, callback, asyncState);
        }
        
        private object[] OnEndTranslate(System.IAsyncResult result) {
            string retVal = ((SayWordByPicture.TextToSpeech.SpeechServer.LanguageService)(this)).EndTranslate(result);
            return new object[] {
                    retVal};
        }
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult SayWordByPicture.TextToSpeech.SpeechServer.LanguageService.BeginAddTranslationArray(string appId, SayWordByPicture.TextToSpeech.SpeechServer.Translation[] translations, string from, string to, SayWordByPicture.TextToSpeech.SpeechServer.TranslateOptions options, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginAddTranslationArray(appId, translations, from, to, options, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        void SayWordByPicture.TextToSpeech.SpeechServer.LanguageService.EndAddTranslationArray(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginAddTranslationArray(object[] inValues, System.AsyncCallback callback, object asyncState) {
            string appId = ((string)(inValues[0]));
            SayWordByPicture.TextToSpeech.SpeechServer.Translation[] translations = ((SayWordByPicture.TextToSpeech.SpeechServer.Translation[])(inValues[1]));
            string from = ((string)(inValues[2]));
            string to = ((string)(inValues[3]));
            SayWordByPicture.TextToSpeech.SpeechServer.TranslateOptions options = ((SayWordByPicture.TextToSpeech.SpeechServer.TranslateOptions)(inValues[4]));
            return ((SayWordByPicture.TextToSpeech.SpeechServer.LanguageService)(this)).BeginAddTranslationArray(appId, translations, from, to, options, callback, asyncState);
        }
        
        private object[] OnEndAddTranslationArray(System.IAsyncResult result) {
            ((SayWordByPicture.TextToSpeech.SpeechServer.LanguageService)(this)).EndAddTranslationArray(result);
            return null;
        }
        ...
        public void AddTranslationArrayAsync(string appId, SayWordByPicture.TextToSpeech.SpeechServer.Translation[] translations, string from, string to, SayWordByPicture.TextToSpeech.SpeechServer.TranslateOptions options) {
            this.AddTranslationArrayAsync(appId, translations, from, to, options, null);
        }
        
        public void AddTranslationArrayAsync(string appId, SayWordByPicture.TextToSpeech.SpeechServer.Translation[] translations, string from, string to, SayWordByPicture.TextToSpeech.SpeechServer.TranslateOptions options, object userState) {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult SayWordByPicture.TextToSpeech.SpeechServer.LanguageService.BeginGetTranslationsArray(string appId, string[] texts, string from, string to, int maxTranslations, SayWordByPicture.TextToSpeech.SpeechServer.TranslateOptions options, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginGetTranslationsArray(appId, texts, from, to, maxTranslations, options, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        SayWordByPicture.TextToSpeech.SpeechServer.GetTranslationsResponse[] SayWordByPicture.TextToSpeech.SpeechServer.LanguageService.EndGetTranslationsArray(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginGetTranslationsArray(object[] inValues, System.AsyncCallback callback, object asyncState) {
            ...
            int maxTranslations = ((int)(inValues[4]));
            SayWordByPicture.TextToSpeech.SpeechServer.TranslateOptions options = ((SayWordByPicture.TextToSpeech.SpeechServer.TranslateOptions)(inValues[5]));
            return ((SayWordByPicture.TextToSpeech.SpeechServer.LanguageService)(this)).BeginGetTranslationsArray(appId, texts, from, to, maxTranslations, options, callback, asyncState);
        }
        
        private object[] OnEndGetTranslationsArray(System.IAsyncResult result) {
            SayWordByPicture.TextToSpeech.SpeechServer.GetTranslationsResponse[] retVal = ((SayWordByPicture.TextToSpeech.SpeechServer.LanguageService)(this)).EndGetTranslationsArray(result);
            return new object[] {
                    retVal};
        }
        ...
        public void GetTranslationsArrayAsync(string appId, string[] texts, string from, string to, int maxTranslations, SayWordByPicture.TextToSpeech.SpeechServer.TranslateOptions options) {
            this.GetTranslationsArrayAsync(appId, texts, from, to, maxTranslations, options, null);
        }
        
        public void GetTranslationsArrayAsync(string appId, string[] texts, string from, string to, int maxTranslations, SayWordByPicture.TextToSpeech.SpeechServer.TranslateOptions options, object userState) {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult SayWordByPicture.TextToSpeech.SpeechServer.LanguageService.BeginSpeak(string appId, string text, string language, string format, string options, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginSpeak(appId, text, language, format, options, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        string SayWordByPicture.TextToSpeech.SpeechServer.LanguageService.EndSpeak(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginSpeak(object[] inValues, System.AsyncCallback callback, object asyncState) {
            ...
            return ((SayWordByPicture.TextToSpeech.SpeechServer.LanguageService)(this)).BeginSpeak(appId, text, language, format, options, callback, asyncState);
        }
        
        private object[] OnEndSpeak(System.IAsyncResult result) {
            string retVal = ((SayWordByPicture.TextToSpeech.SpeechServer.LanguageService)(this)).EndSpeak(result);
            return new object[] {
                    retVal};
        }
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult SayWordByPicture.TextToSpeech.SpeechServer.LanguageService.BeginTranslateArray(string appId, string[] texts, string from, string to, SayWordByPicture.TextToSpeech.SpeechServer.TranslateOptions options, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginTranslateArray(appId, texts, from, to, options, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        SayWordByPicture.TextToSpeech.SpeechServer.TranslateArrayResponse[] SayWordByPicture.TextToSpeech.SpeechServer.LanguageService.EndTranslateArray(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginTranslateArray(object[] inValues, System.AsyncCallback callback, object asyncState) {
            ...
            string to = ((string)(inValues[3]));
            SayWordByPicture.TextToSpeech.SpeechServer.TranslateOptions options = ((SayWordByPicture.TextToSpeech.SpeechServer.TranslateOptions)(inValues[4]));
            return ((SayWordByPicture.TextToSpeech.SpeechServer.LanguageService)(this)).BeginTranslateArray(appId, texts, from, to, options, callback, asyncState);
        }
        
        private object[] OnEndTranslateArray(System.IAsyncResult result) {
            SayWordByPicture.TextToSpeech.SpeechServer.TranslateArrayResponse[] retVal = ((SayWordByPicture.TextToSpeech.SpeechServer.LanguageService)(this)).EndTranslateArray(result);
            return new object[] {
                    retVal};
        }
        ...
        public void TranslateArrayAsync(string appId, string[] texts, string from, string to, SayWordByPicture.TextToSpeech.SpeechServer.TranslateOptions options) {
            this.TranslateArrayAsync(appId, texts, from, to, options, null);
        }
        
        public void TranslateArrayAsync(string appId, string[] texts, string from, string to, SayWordByPicture.TextToSpeech.SpeechServer.TranslateOptions options, object userState) {
        ...
        protected override SayWordByPicture.TextToSpeech.SpeechServer.LanguageService CreateChannel() {
            return new LanguageServiceClientChannel(this);
        }
        
        private class LanguageServiceClientChannel : ChannelBase<SayWordByPicture.TextToSpeech.SpeechServer.LanguageService>, SayWordByPicture.TextToSpeech.SpeechServer.LanguageService {
            
            public LanguageServiceClientChannel(System.ServiceModel.ClientBase<SayWordByPicture.TextToSpeech.SpeechServer.LanguageService> client) : 
                    base(client) {
            }
            ...
            public System.IAsyncResult BeginGetTranslations(string appId, string text, string from, string to, int maxTranslations, SayWordByPicture.TextToSpeech.SpeechServer.TranslateOptions options, System.AsyncCallback callback, object asyncState) {
            ...
            public SayWordByPicture.TextToSpeech.SpeechServer.GetTranslationsResponse EndGetTranslations(System.IAsyncResult result) {
                object[] _args = new object[0];
                SayWordByPicture.TextToSpeech.SpeechServer.GetTranslationsResponse _result = ((SayWordByPicture.TextToSpeech.SpeechServer.GetTranslationsResponse)(base.EndInvoke("GetTranslations", _args, result)));
                return _result;
            }
            ...
            public System.IAsyncResult BeginAddTranslationArray(string appId, SayWordByPicture.TextToSpeech.SpeechServer.Translation[] translations, string from, string to, SayWordByPicture.TextToSpeech.SpeechServer.TranslateOptions options, System.AsyncCallback callback, object asyncState) {
            ...
            public System.IAsyncResult BeginGetTranslationsArray(string appId, string[] texts, string from, string to, int maxTranslations, SayWordByPicture.TextToSpeech.SpeechServer.TranslateOptions options, System.AsyncCallback callback, object asyncState) {
                object[] _args = new object[6];
                _args[0] = appId;
                _args[1] = texts;
                _args[2] = from;
            ...
            public SayWordByPicture.TextToSpeech.SpeechServer.GetTranslationsResponse[] EndGetTranslationsArray(System.IAsyncResult result) {
                object[] _args = new object[0];
                SayWordByPicture.TextToSpeech.SpeechServer.GetTranslationsResponse[] _result = ((SayWordByPicture.TextToSpeech.SpeechServer.GetTranslationsResponse[])(base.EndInvoke("GetTranslationsArray", _args, result)));
                return _result;
            }
            ...
            public System.IAsyncResult BeginTranslateArray(string appId, string[] texts, string from, string to, SayWordByPicture.TextToSpeech.SpeechServer.TranslateOptions options, System.AsyncCallback callback, object asyncState) {
                object[] _args = new object[5];
                _args[0] = appId;
                _args[1] = texts;
                _args[2] = from;
            ...
            public SayWordByPicture.TextToSpeech.SpeechServer.TranslateArrayResponse[] EndTranslateArray(System.IAsyncResult result) {
                object[] _args = new object[0];
                SayWordByPicture.TextToSpeech.SpeechServer.TranslateArrayResponse[] _result = ((SayWordByPicture.TextToSpeech.SpeechServer.TranslateArrayResponse[])(base.EndInvoke("TranslateArray", _args, result)));
                return _result;
            }
        }
    }
